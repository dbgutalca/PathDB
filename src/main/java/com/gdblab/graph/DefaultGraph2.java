...
public final class DefaultGraph2 {
    ...
    public static Edge[] getDefaultEdges() {
        ...
        edges[4] = new Edge("E5", "Likes", graph.getNode("p1"), graph.getNode("m1"), new HashMap<String, String>());
        edges[5] = new Edge("E6", "Likes", graph.getNode("p3"), graph.getNode("m2"), new HashMap<String, String>());
        edges[6] = new Edge("E7", "Likes", graph.getNode("p4"), graph.getNode("m3"), new HashMap<String, String>());
        edges[7] = new Edge("E8", "Likes", graph.getNode("p2"), graph.getNode("m3"), new HashMap<String, String>());
        edges[8] = new Edge("E9", "HasCreator", graph.getNode("m1"), graph.getNode("p3"), new HashMap<String, String>());
        edges[9] = new Edge("E10", "HasCreator", graph.getNode("m2"), graph.getNode("p4"), new HashMap<String, String>());
        edges[10] = new Edge("E11", "HasCreator", graph.getNode("m3"), graph.getNode("p1"), new HashMap<String, String>());
        return edges;
    }
}
