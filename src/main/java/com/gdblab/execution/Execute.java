        ...
        try {
            ...
            while (true) {
                ...
                if (line.equals(prefix + "h") || line.equals(prefix + "help")) {
                    ...
                    System.out.println("Set to calculate " + parts[1] + " paths.\n");
                    continue;
                }
    ...
    public static void experimental(String[] args) {
        ...
        for (String line : rpqs) {
            ...
            try {
                sn = data[9];
                if (!sn.isEmpty()) {
                    Context.getInstance().setStartNodeProp("id");
                    Context.getInstance().setStartNodeValue(sn);
                }
                else {
                    Context.getInstance().setStartNodeProp("");
                    Context.getInstance().setStartNodeValue("");
            ...
            try {
                ...
                if (!en.isEmpty()) {
                    Context.getInstance().setEndNodeProp("id");
                    Context.getInstance().setEndNodeValue(en);
                }
                else {
                    Context.getInstance().setEndNodeProp("");
                    Context.getInstance().setEndNodeValue("");
